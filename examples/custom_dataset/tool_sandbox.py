...
Adapted for custom true/false reasoning tasks with tool integration.
...
TOOL_CONFIGS = {
    "max_turns": 12,  # Reduced for true/false tasks
    "max_tool_calls": 8,  # Sufficient for reasoning tasks
    "tool_concurrency": 16,  # Moderate concurrency
    # Python interpreter settings
    "python_timeout": 60,  # 1 minute for calculations
    "python_memory_limit": "2GB",  # 2GB per Python process
    "python_cpu_limit": 1,
    # Memory management settings
    "max_memory_usage": 8192,  # 8GB total
    "cleanup_threshold": 4096,  # 4GB
    "aggressive_cleanup_threshold": 2048,  # 2GB
    "force_cleanup_threshold": 6144,  # 6GB
}
...
def aggressive_cleanup_memory():
    ...
    if hasattr(sys, "modules"):
        ...
        modules_to_clear = ["numpy", "pandas", "matplotlib", "scipy", "sympy"]
...
class PythonSandbox:
    ...
    def __init__(self, timeout: int = 60, memory_limit: str = "2GB"):
        self.timeout = timeout
        self.memory_limit = memory_limit
        # Extended allowed modules for reasoning tasks
    ...
    def _check_code_safety(self, code: str) -> tuple[bool, str]:
        ...
        dangerous_patterns = [
            ...
            r"vars\s*\(",
            r"dir\s*\(",
            # Allow type() and isinstance() for reasoning
            # r"type\s*\(",
            # r"isinstance\s*\(",
            r"issubclass\s*\(",
            r"super\s*\(",
        ...
        self.register_tool(
            "code_interpreter",
            {
                ...
                "function": {
                    ...
                    "description": "Execute Python code to perform calculations, verify facts, or analyze data. Supports math, statistics, numpy, sympy, and pandas.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "code": {
                                "type": "string",
                                "description": "The Python code to execute. Can include mathematical computations, logical operations, data analysis, etc."
                            }
                        },
                        "required": ["code"],
                    },
